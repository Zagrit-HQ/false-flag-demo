...
Playwright `globalSetup` seeds the shared dashboard baseline and the
isolated edit corpus through the API. No separate `make seed` step is
required for dashboard e2e.
