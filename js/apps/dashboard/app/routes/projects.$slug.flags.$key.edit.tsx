...
export default function EditFlag() {
  ...
  // editor.client.tsx is an empty module during SSR, so the lazy import's
  // default export is undefined on the server — rendering it throws
  // "Element type is invalid". Gate the editor behind a client-only mount
  // flag so the server (and first hydration pass) renders the skeleton.
