...
6. **Validation ladder + close-out.** Add `make generate-check` and
   ...
   validation ladder, flip plan status to `completed`. Owns:
   `Makefile` and this plan.
...
Acceptance: every command above exits 0; this plan marked completed;
ready to start slice 4.
