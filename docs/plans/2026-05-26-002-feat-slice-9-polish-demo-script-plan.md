...
five "Known gaps deferred" items captured in the 2026-05-26 planning notes
...
mechanical: walk the four files planning notes flagged, update HTTP 400
...
- `tests/hurl/03-evaluate.hurl`, `tests/hurl/08-evaluate-trace.hurl`,
  ...
  the planning notes's claim that all four were broken is downstream
...
**Approach:** option (a) from the planning notes — toast on the view
...
Per planning notes, the following stay deferred (slice 10+ or
maintainer-owned):
...
- **Slice 8 plans:** `docs/plans/2026-05-22-001-feat-server-ts-compile-and-edit-ui-plan.md`
  and `docs/plans/2026-05-26-001-feat-slice-8-phases-4-9-finish-edit-ui-plan.md`.
...
- `bd5b1ba` — planning notes tightening that pinned the slice 9 pickup list.
...
5. `docs: slice 9 demo polish — README, walkthrough, diagram, script`
