...
realistic "slow CI to optimize" target
...
`backend: [postgres, sqlite]` matrix axis on `test-go`,
...
- `.github/workflows/ci.yml`:
  - Backend-sensitive CI jobs add `strategy.matrix.backend: [postgres, sqlite]`
...
- [ ] `contract-test`, `smoke`, `dashboard-e2e`
...
- **Migration parity checking** — by planning notes design, schemas drift.
...
- **Ideation:** `docs/ideation/2026-05-20-synthetic-feature-flag-platform-depot-demo-ideation.md`
  — product direction and slow-CI framing.
