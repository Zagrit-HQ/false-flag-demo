...
const (
	...
	HealthServiceName = "falseflag.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/falseflag.v1.HealthService/Check"
)

// HealthServiceClient is a client for the falseflag.v1.HealthService service.
type HealthServiceClient interface {
	// Check returns the current serving status of the FalseFlag binary.
	Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error)
}

// NewHealthServiceClient constructs a client for the falseflag.v1.HealthService service. By
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_falseflag_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls falseflag.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the falseflag.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/falseflag.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("falseflag.v1.HealthService.Check is not implemented"))
}
