...
// contends with itself — appropriate for a Hurl-style sequential
// workload and the production hardening goalpost set in the slice 10
// plan (demo quality, not high-concurrency tuning).
