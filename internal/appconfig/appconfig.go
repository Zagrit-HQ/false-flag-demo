...
type ProxyConfig struct {
	...
	// ReadyFlags is an optional comma-separated list of flag keys that
	// must exist in the loaded snapshot before /readyz returns 200.
	ReadyFlags []string // FALSEFLAG_PROXY_READY_FLAGS, optional
}
...
func LoadProxy() (ProxyConfig, error) {
	return ProxyConfig{
		...
		ReadyFlags:  getEnvCSV("FALSEFLAG_PROXY_READY_FLAGS"),
	}, nil
}
